...
function App() {
    ...
    let todoFromServer: TypeTodoFromServer[] = [
        {
            title: "What to learn",
            filter: "all",
            tasks: [
    ...
    function removeTask(taskId: string, todolistIdcurrent: string) {
        setTodo(todo.map(el=>el.todolistID === todolistIdcurrent
            ? {...el, tasks: el.tasks.filter(fl => fl.taskId!==taskId)}
            :el))
    }

    function addTask(title: string, todolistIdcurrent: string) {
    ...
    function changeFilter(value: FilterValuesType, todolistIdCurrent: string) {
        setTodo(todo.map(el => el.todolistID === todolistIdCurrent
            ? {...el, filter: value}
            : el
        ))
    ...
    function removeTodolist(todolistIdCurrent: string) {
